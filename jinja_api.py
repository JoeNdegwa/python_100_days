...
posts = requests.get("https://api.npoint.io/5d9c15e572c636dadc38").json()
post_objects = []
for post in posts:
...
"""index html ==> within templates folder
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
"""post html ==> within templates folder
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
"""stlyes css file ==> within static folder
body{
 background: #efeff3;
 margin: 0;
